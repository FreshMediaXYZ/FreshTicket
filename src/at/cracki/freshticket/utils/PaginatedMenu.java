...
public abstract class PaginatedMenu extends Menu {
    ...
    public void addPaginatedMenuBorder(){
        inventory.setItem(48, new Item(Material.DARK_OAK_BUTTON).setName("§aLeft").toItemStack());

        inventory.setItem(49, new Item(Material.BARRIER).setName("§c§lClose").toItemStack());

        inventory.setItem(50, new Item(Material.DARK_OAK_BUTTON).setName("§aRight").toItemStack());
